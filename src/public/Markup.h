...
#define MCD_STRCAPACITY(s) (int)std::string(s).capacity()
...
public:
	...
	//baiyadong begin
	static MCD_STR UTF8ToGB2312( MCD_CSTR pszUTF8, int* pnFailed = NULL );
	static MCD_STR GB2312ToUTF8( MCD_CSTR pszGB2312 );	
	//baiyadong end
